...
#ifndef select_case_REFERENCE_INCLUDED
#define select_case_REFERENCE_INCLUDED




//template<typename T>
void __attribute__((noinline)) select_case_reference(order *orders, uint64_t o_records, output *result) {
    double discount = 0;
